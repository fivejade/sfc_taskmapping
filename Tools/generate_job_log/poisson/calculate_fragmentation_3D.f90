...
Subroutine calculate_fragmentation_3D_host_level_z(nx, ny, nz, fragment, hilbert)
implicit none
...
fragment = 0.0
do k=1,nz
    fragment = fragment + frags(k)
enddo
fragment = fragment/real(nz)
deallocate(frags)
End Subroutine

Subroutine calculate_fragmentation_3D_host_level_y(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert
...
subroutine calculate_fragmentation_3D_host_level_x(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert
    ...
    enddo
    fragment = fragment/real(nx)
    deallocate(frags)
End Subroutine
    
Subroutine calculate_fragmentation_2D_edge_level_z(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert
...
Subroutine calculate_fragmentation_2D_edge_level_y(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert
...
subroutine calculate_fragmentation_2D_edge_level_x(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert
...
Subroutine calculate_fragmentation_2D_core_level_z(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert
...
Subroutine calculate_fragmentation_2D_core_level_y(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert
...
subroutine calculate_fragmentation_2D_core_level_x(nx, ny, nz, fragment, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny, nz
    real*4, intent(inout) :: fragment
    logical, intent(in) :: hilbert

...
Subroutine calculate_fragmentation_2D_host_level_y(nx, ny, fragmentation, hilbert)
implicit none
...
do j=1,ny
    ...
    cnt2=0
    do k=1,nx
        new_rankID1=(k-1)*ny+j
        do l=1,k-1
            new_rankID2=(l-1)*ny+j
            if (hilbert) then
...
Subroutine calculate_fragmentation_2D_host_level_x(nx, ny, fragmentation, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny
    real*4, intent(inout) :: fragmentation
    logical, intent(in) :: hilbert
    ...
    do j=1,nx
        ...
        cnt2=0
        do k=1,ny
            new_rankID1=(j-1)*ny+k
            do l=1,k-1
                new_rankID2=(j-1)*ny+l
                if (hilbert) then
                    if (in_same_node(node_info_list(newnode_list(new_rankID1-1))%host_id,&
                        node_info_list(newnode_list(new_rankID2-1))%host_id)) cnt1=cnt1+1
                else
...
Subroutine calculate_fragmentation_2D_edge_level_y(nx, ny, fragmentation, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny
    real*4, intent(inout) :: fragmentation
    logical, intent(in) :: hilbert
...
Subroutine calculate_fragmentation_2D_edge_level_x(nx, ny, fragmentation, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny
    real*4, intent(inout) :: fragmentation
    logical, intent(in) :: hilbert
...
Subroutine calculate_fragmentation_2D_core_level_y(nx, ny, fragmentation, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny
    real*4, intent(inout) :: fragmentation
    logical, intent(in) :: hilbert
...
Subroutine calculate_fragmentation_2D_core_level_x(nx, ny, fragmentation, hilbert)
    implicit none
    integer*4, intent(in) :: nx, ny
    real*4, intent(inout) :: fragmentation
    logical, intent(in) :: hilbert
